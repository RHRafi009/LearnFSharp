...
// playing with types
let rafi = {First="Rafi";Last="Khandakar"}
let worker2 = Worker person1
let worker3 = Worker rafi // as a manager
let personList = [worker;worker2;worker3]
let managedEmployee = Manager personList
printf "%A" managedEmployee
// ========= Printing =========
